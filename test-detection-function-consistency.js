...
async function testDetectionFunctionConsistency() {
  console.log('🔍 DETECTION FUNCTION CONSISTENCY TEST');
  console.log('======================================');
  console.log('Testing if detectAndGroupMultipleChoice is consistent\n');
...
Analyze and return the JSON array:`;
        ...
        console.log('\n📊 DETECTION FUNCTION CONSISTENCY ANALYSIS');
        console.log('==========================================');
        ...
        console.log('\n🎯 DETECTION FUNCTION CONSISTENCY CONCLUSION:');
        console.log('============================================');
        
        if (successfulRuns.length === 3 && successfulRuns.every(r => r.multipleChoiceCount === successfulRuns[0].multipleChoiceCount)) {
          console.log('✅ DETECTION FUNCTION IS CONSISTENTLY WORKING!');
          console.log('   The issue must be elsewhere in the frontend.');
        } else if (successfulRuns.length === 0) {
          console.log('❌ DETECTION FUNCTION IS CONSISTENTLY FAILING!');
          console.log('   All runs are falling back to single questions.');
          console.log('   This explains why multiple choice formatting doesn\'t work!');
        } else {
          console.log('❌ DETECTION FUNCTION IS INCONSISTENT!');
          console.log('   Some runs succeed, some fail.');
          console.log('   This explains the intermittent multiple choice behavior!');
        }
...
// Run the detection function consistency test
testDetectionFunctionConsistency(); 