...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Swap every pair of consecutive elements in the array.
    \end{itemize}
    \begin{enumerate}
        \item  Describe what the algorithm does. What is the final state of the array after the algorithm terminates?  Explain your answer.
