...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Use a recursion tree to give an upper bound for the recurrence and get a closed-form expression for $T(n)$, when $n$ is a power of 2. (Check that your expression is an upper bound by plugging in $n = 4$ and comparing with your answer to (a).)
    ...
    \begin{itemize}
        ...
        \item Swap adjacent elements if they are out of order.
    \end{itemize}
    \begin{enumerate}
        \item Write a recurrence expressing the running time of the algorithm.  Assume the swap operation takes O(1) time.
        \item Apply Our Master Theorem to your recurrence. What is the running time of the algorithm, in theta notation?  Is this a correct sorting algorithm? Explain.
    \end{enumerate}

    \item  Design a divide-and-conquer algorithm to find the maximum and minimum elements in an unsorted array of $n$ elements.
    \begin{enumerate}
        \item Describe your algorithm recursively.
        \item Write a recurrence relation for the running time of your algorithm.
        \item Solve the recurrence relation using Our Master Theorem to find the time complexity of your algorithm.
    \end{enumerate}
