...
class ActivityController {
  ...
  async startNewGame(req, res) {
    return this.neuralConquestController.startNewGame(req, res);
  }

  async joinGame(req, res) {
    return this.neuralConquestController.joinGame(req, res);
  }

  async saveGameState(req, res) {
    return this.neuralConquestController.saveGameState(req, res);
  }
  ...
  async generateAITurn(req, res) {
    return this.neuralConquestController.generateAITurn(req, res);
  }
